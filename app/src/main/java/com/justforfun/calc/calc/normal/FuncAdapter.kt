...
class FuncAdapter(private val text: List<String>,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val view: View
        if (convertView == null) {
            view = LayoutInflater.from(MainActivity.activity).inflate(R.layout.button_function, parent, false)
        ...
        viewHolder.vice?.text = vice[position]
        return view
    }
